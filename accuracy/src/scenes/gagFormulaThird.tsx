...
export default makeScene2D(function* (view) {
  ...
  yield* all(
    ...
    tgtDef().opacity(1, 0.2),
    cogDefence.txtRef().opacity(1, 0.2),
    cogDefence.lineRef().opacity(1, 0.2),

    tgtDef().scale(1.2, 0.5).to(1, 0.3),
    cogDefence.txtRef().scale(1.2, 0.5).to(1, 0.3),
);
